 ...
 * @return {Object} return an object with two propertiess: ipv4 and ipv6.{ @description .The values of its properties will be strings.}
...
function getFirstIpAddress(cidrStr, callback) {
    ...
    let res = {}
    res.ipv4 = firstIpAddress;
    res.ipv6 = ipv4MappedIpv6; 
...
function main() {
    ...
    for (let i = 0; i < sampleCidrsLen; i++) {
        ...
        /*
        let res = getFirstIpAddress(sampleCidrs[i]);
         console.log(`  Response returned from GET request: ${res.ipv4}`);
         console.log(`  IPv4 ${res.ipv4} mapped to IPv6 Address: ${res.ipv6}`);
         */
    }
